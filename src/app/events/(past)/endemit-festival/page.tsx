      ...
      >
        <div className="text-center absolute left-0 w-full flex flex-col items-center top-[8%] md:top-[12%]">
          ...
          <div className="text-center text-2xl md:text-3xl lg:text-4xl font-bold  text-neutral-200 mt-4 lg:w-2/3 md:w-4/5 mx-4">
            ...
            <br></br>
            <br></br>
            This time, we move quietly. No big posts, no loud invites. Just us –
            and those we trust to feel the same. The word travels from friend to
            friend. From heart to heart. From those who hear the silence between
            the bass. Hidden, but deeply connected.{" "}
          </div>
        </div>
      </div>
    </div>
