 ...
 * a `next/dynamic(..., { ssr:false })` gate (this one via
 * `ThemeWebGLBackground`, `RaveonVfxScene` via the Vfx slice), which places
 * three + r3f + the scene in a separate lazy chunk that no page or shared
 * chunk references. A general (non-themed) page therefore never downloads a
 * byte of three. Do NOT import three from anywhere else, and do NOT import
 * scene files except via their dynamic gates.
 *
