...
function NewOrderToMerchantTemplate({ order }: Props) {
  if (!order.items) {
    return null;
  }
  ...
  return (
    <MasterTemplate>
      <div>
        ...
        {hasTicketItems && (
          <Text className="text-gray-600 mb-6">
            The order contains tickets which will be sent to the customers email
        ...
        {shippingAddress && (
          ...
          >
            <Text className="font-semibold mb-2">Shipping the order to:</Text>
...
export { NewOrderToMerchantTemplate };
