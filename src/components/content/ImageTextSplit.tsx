        ...
        <div className="relative z-10 w-full mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {cta && (
              <Link
                href={cta.href}
                className="inline-block px-8 py-3 bg-white text-gray-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors w-fit"
              >
                {cta.text}
              </Link>
            )}
      ...
      >
        ...
        >
          ...
          {cta && (
            <Link
              href={cta.href}
              className="inline-block px-8 py-3 bg-gray-900 text-white font-semibold rounded-lg hover:bg-gray-800 transition-colors w-fit"
            >
              {cta.text}
            </Link>
          )}
